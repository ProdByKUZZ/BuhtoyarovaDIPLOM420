import { Phone, MapPin, Clock, Mail, Home, Ambulance, Briefcase, MessageSquare, Play, Users } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <img src={logoImg} alt="Медикал Плюс" className="w-10 h-10 rounded-full" />
