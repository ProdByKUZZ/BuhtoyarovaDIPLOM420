...
import { Menu, Phone, X, User, Calendar } from "lucide-react";
    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass shadow-soft animate-slide-down">
      <div className="container flex items-center justify-between py-4">
        ...
        <a href="#" className="flex items-center gap-3 group">
          <img src={logoImg} alt="Медикал Плюс" className="w-11 h-11 rounded-full transition-transform group-hover:scale-105" />
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-b text-center">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <img src={logoImg} alt="Медикал Плюс" className="w-11 h-11 rounded-full" />
